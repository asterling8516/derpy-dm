...
tags:
  ...
  - save-wisdom
  - spell
url: https://derpydm.com/dd/spells/1st-level/cause-fear
---
# Cause Fear
...
*<p class="Core-Styles_Core-Body">You awaken the sense of mortality in one creature you can see within range. A construct or an undead is immune to this effect. The target must succeed on a Wisdom save or become frightened of you until the spell ends. The frightened target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.</p>

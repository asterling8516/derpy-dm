...
**Evasion.** If the creature is subjected to an effect that allows it to make a Dexterity save to take only half damage, the creature instead takes no damage if it succeeds on the saving throw, and only half damage if it fails.

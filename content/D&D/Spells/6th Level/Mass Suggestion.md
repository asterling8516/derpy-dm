...
tags:
  ...
  - save-wisdom
  - spell
url: https://derpydm.com/dd/spells/6th-level/mass-suggestion
---
# Mass Suggestion
...
Each target must succeed on a Wisdom save or have the Charmed condition for the duration or until you or your allies deal damage to the target. Each Charmed target pursues the suggestion to the best of its ability. The suggested activity can continue for the entire duration, but if the suggested activity can be completed in a shorter time, the spell ends for a target upon completing it.

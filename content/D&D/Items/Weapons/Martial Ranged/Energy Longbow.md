...
tags:
  ...
  - save-strength
  - weapons
url: https://derpydm.com/dd/items/weapons/martial-ranged/energy-longbow
---
# Energy Longbow
...
***Arrow of Restraint.*** Whenever you use this weapon to make a ranged attack against a creature, you can try to restrain the target instead of dealing damage to it. If the arrow hits, the target must succeed on a DC 15 Strength save or have the Restrained condition for 1 minute. As an action, a creature Restrained by an arrow can make a DC 20 Strength ([[Athletics]]) check to try to break the restraint, ending the effect on itself on a successful check.

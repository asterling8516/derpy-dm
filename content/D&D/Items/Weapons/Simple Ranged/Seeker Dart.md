...
When the dart reaches its target, the target must succeed on a DC 16 Dexterity save or take  [[/damage 1d4 type=piercing average=true]] damage and  [[/damage 3d4 type=lightning average=true]] damage. The dart’s magic is then spent, and it becomes an ordinary dart.</p>*
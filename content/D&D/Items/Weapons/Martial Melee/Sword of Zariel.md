...
***Searing Radiance.*** The sword deals an extra  [[/damage 2d8 type=radiant average=true]] damage to any creature it hits, or  [[/damage 3d10 type=radiant average=true]] damage if you’re wielding the weapon with two hands. An evil creature that takes this radiant damage must succeed on a DC 17 Constitution save or be blinded until the end of its next turn.

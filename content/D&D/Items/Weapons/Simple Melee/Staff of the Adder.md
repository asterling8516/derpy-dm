...
You can make a melee attack using the snake head, which has a reach of 5 feet. Your proficiency bonus applies to the attack roll. On a hit, the target takes  [[/damage 1d6 type=piercing average=true]] damage and must succeed on a DC 15 Constitution save or take  [[/damage 3d6 type=poison average=true]] damage.

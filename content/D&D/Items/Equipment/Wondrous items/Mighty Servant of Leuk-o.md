...
If the crew members successfully implement the code, at the end of the third round, the servant explodes. Every creature in a 100-foot-radius sphere centered on the servant must make a DC 25 Dexterity save. On a failed save, a creature takes  [[/damage 25d6 type=force average=true]] damage,  [[/damage 25d6 type=lightning average=true]] damage, and  [[/damage 25d6 type=thunder average=true]] damage. On a successful save, a creature takes half as much damage. Objects and structures in the area take triple damage. Creatures inside the servant are slain instantly and leave behind no remains.

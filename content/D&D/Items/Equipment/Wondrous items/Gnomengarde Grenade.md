...
* Each creature must make a DC 15 Dexterity save, taking  [[/damage 8d6 type=fire average=true]] damage on a failed save, or half as much fire damage on a successful one.
* Each creature must make a DC 15 Constitution save. On a failed save, it takes  [[/damage 8d6 type=thunder average=true]] damage and is stunned until the end of its next turn. On a successful save, it takes half as much thunder damage and is not stunned.
